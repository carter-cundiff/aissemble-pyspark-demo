...
def gitId = 'github'
def gitRepo = 'https://github.com/carter-cundiff/aissemble-pyspark-demo.git'
...
withGit url: gitRepo, cred: gitId, branch: gitBranch, {
    try {
        ...
        slackSend color: "good",
                message: "pyspark-demo released successfully"

    } catch (err) {
        slackSend color: "danger",
                message: "pyspark-demo failed to release successfully"
        throw err
    }
}
